...
my $default_manager = $::lx_office_conf{system}->{default_manager};
...
if ($default_manager eq "swiss") {
  is($::form->round_amount(1.05, 2, 1), '1.05', '1.05 @ 2/1');
} else {
  is($::form->round_amount(1.05, 2, 1), '1.05', '1.05 @ 2/1');
}
...
if ($default_manager eq "swiss") {
  is($::form->round_amount(1.045, 2, 1), '1.05', '1.045 @ 2/1');
} else {
  is($::form->round_amount(1.045, 2, 1), '1.05', '1.045 @ 2/1');
}
...
if ($default_manager eq "swiss") {
  is($::form->round_amount(33.675, 2, 1), '33.7', '33.675 @ 2/1');
} else {
  is($::form->round_amount(33.675, 2, 1), '33.68', '33.675 @ 2/1');
}
...
if ($default_manager eq "swiss") {
  is($::form->round_amount(64.475, 2, 1), '64.5', '64.475 @ 2/1');
} else {
  is($::form->round_amount(64.475, 2, 1), '64.48', '64.475 @ 2/1');
}
...
if ($default_manager eq "swiss") {
  is($::form->round_amount(64.475499, 2, 1), '64.5', '64.475499 @ 2/1');
} else {
  is($::form->round_amount(64.475499, 2, 1), '64.48', '64.475499 @ 2/1');
}
...
if ($default_manager eq "swiss") {
  is($::form->round_amount(64.475999, 2, 1), '64.5', '64.475999 @ 2/1');
} else {
  is($::form->round_amount(64.475999, 2, 1), '64.48', '64.475999 @ 2/1');
}
...
if ($default_manager eq "swiss") {
  is($::form->round_amount(44.9 * 0.75, 2, 1), '33.7', '44.9 * 0.75 @ 2/1');
} else {
  is($::form->round_amount(44.9 * 0.75, 2, 1), '33.68', '44.9 * 0.75 @ 2/1');
}
...
if ($default_manager eq "swiss") {
  is($::form->round_amount(143.20, 2, 1), '143.2', '143.20 @ 2/1');
} else {
  is($::form->round_amount(143.20, 2, 1), '143.2', '143.20 @ 2/1');
}
...
if ($default_manager eq "swiss") {
  is($::form->round_amount(149.175, 2, 1), '149.2', '149.175 @ 2/1');
} else {
  is($::form->round_amount(149.175, 2, 1), '149.18', '149.175 @ 2/1');
}
...
if ($default_manager eq "swiss") {
  is($::form->round_amount(198.90 * 0.75, 2, 1), '149.2', '198.90 * 0.75 @ 2/1');
} else {
  is($::form->round_amount(198.90 * 0.75, 2, 1), '149.18', '198.90 * 0.75 @ 2/1');
}
